# 🪑 Project03 | 동서가구 리뉴얼 – 가구 쇼핑몰 프로젝트
[**사이트 바로가기**] https://wadzuswl.github.io/project03/

## 프로젝트 개요

### 프로젝트 주제
**가구 쇼핑몰 웹사이트 리뉴얼**  
사용자 경험을 중심으로 인터페이스를 재설계하고, 다양한 디바이스 환경에서도 일관된 사용성을 제공하는 완전 반응형 이커머스 플랫폼을 구현했습니다.
...
**구현 목표**: 구매 결정에 필요한 정보를 제공하고, 장바구니 흐름을 완성
